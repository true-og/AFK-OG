...
public class AfkConfig {
	...
	private void load(FileConfiguration config) {
		...
		this.afkBroadcastMessage = config.getString("afk-broadcast-message", "%prefix%%player% &7is now AFK.");
		this.afkBroadcastReturnMessage = config.getString("afk-broadcast-return-message", "%prefix%%player% &7is no longer AFK.");
